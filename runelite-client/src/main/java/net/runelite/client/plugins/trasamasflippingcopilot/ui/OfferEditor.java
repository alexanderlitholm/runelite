...
import net.runelite.client.plugins.trasamasflippingcopilot.controller.OfferHandler;
import net.runelite.client.plugins.trasamasflippingcopilot.model.OfferManager;
